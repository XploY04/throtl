...
export function HeroSection() {
  return (
    <section className="relative min-h-[70vh] mt-16 flex items-center" aria-label="Hero">
      ...
      >
        <motion.h1 variants={FADE_IN_UP} className="text-5xl md:text-7xl font-extrabold tracking-tight">
          Tame your network chaos <br/> <span className="parisienne-regular text-8xl"> automatically</span><span className="text-neutral-600">.</span>
        </motion.h1>
        <motion.p variants={FADE_IN_UP} className="mt-4 max-w-2xl mx-auto text-xl text-neutral-400">
        ...
        <motion.div variants={FADE_IN_UP} className="mt-12 flex items-center justify-center gap-4">
